...
The userspace component of the Loadbalancer sends out periodically health checks to the targets.
If a target fails to respond 3 times it will be removed from the target pool.

## Debugging traffic

The project contains tools to debug traffic using [xdpdump](https://github.com/xdp-project/xdp-tools/tree/main/xdp-dump), [xdp-monitor](https://github.com/xdp-project/xdp-tools/tree/main/xdp-monitor)  and [pwru](github.com/cilium/pwru).
